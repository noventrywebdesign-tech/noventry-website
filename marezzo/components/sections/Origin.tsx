...
export default function Origin() {
  ...
  return (
    <section className="relative bg-char-900 px-6 py-24 md:px-16 md:py-32">
      <div className="mx-auto max-w-[1600px]">
        <Reveal>
          <p className="eyebrow mb-6">03 / Provenance</p>
        </Reveal>
        <Reveal delay={0.1}>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-6 md:p-8">
                  <p className="text-sm font-medium uppercase tracking-[0.14em] text-copper-400">{current.cut}</p>
                  <p className="mt-2 max-w-sm text-lg text-linen-50">{current.quality}</p>
