  ...
  return (
    <section className="relative flex min-h-[90vh] items-center justify-center overflow-hidden bg-char-950">
      <div className="absolute inset-0">
        <Media src="/images/interior-wide.jpg" alt="The dining room at Marezzo" className="h-full w-full animate-drift-slow" />
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 text-center">
        <Reveal>
          <p className="eyebrow mb-8 justify-center">Reservations</p>
        </Reveal>
        <TextReveal
          as="h2"
        ...
        <Reveal delay={0.25}>
          <p className="mx-auto mt-8 max-w-md text-lg text-linen-300">
            Mayfair, seven nights a week — walk-ins welcome at the bar, but the fire is worth booking ahead for.
          </p>
        </Reveal>
        <Reveal delay={0.35}>
          <button
